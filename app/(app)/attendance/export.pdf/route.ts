 ...
 *
 * Rows come from `getMonthReportRows` — the SAME resolver the dashboard page
 * and the XLSX export use — so all three agree for every month. Calling
 * `getMonthDashboard` directly here made HR-sheet-era months (through July
 * 2026) print numbers the UI never showed.
 */
