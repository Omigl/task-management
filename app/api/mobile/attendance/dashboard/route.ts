 ...
 *
 * Reuses `getMonthReportRows` — one source of truth with the web dashboard and
 * the XLSX/PDF exports, so a sheet-era month (through July 2026) reports the
 * frozen HR-sheet counts here too. It previously called `getMonthDashboard`
 * directly, which returned live punch grading and made the native app disagree
 * with the web report for exactly those months.
 */
