...
export function IdleTimer({ timeoutMs, warningMs = 30_000, onTimeout }: Props) {
  ...
  // z-[95] beats the onboarding nudge (z-90), which also lives in the
  // bottom-right corner — an imminent sign-out must never be covered by it.
  return (
    <div
      role="alert"
      className="fixed bottom-6 right-6 z-[95] max-w-sm rounded-section border border-hairline bg-surface-card shadow-lg p-4 flex items-center gap-3"
